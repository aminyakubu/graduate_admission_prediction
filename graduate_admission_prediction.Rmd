...
We see that university rating and sop are not associated with chance of admission due to their large p values. We will remove the variables `university_rating` and `sop`. 
